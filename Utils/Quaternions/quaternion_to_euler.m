function [ eul ] = quaternion_to_euler(q, sequence)
    % eul Convert quaternion to Euler angles
    %   [ eul ] = quaternion_to_euler( q, sequence ). Converts a unit quaternion rotation into the corresponding Euler angles by the axis rotation sequence.
    ...
    switch sequence
        ...
        otherwise
            error('[ quaternion_to_euler::sequence ] unknown sequence');
    end
end
