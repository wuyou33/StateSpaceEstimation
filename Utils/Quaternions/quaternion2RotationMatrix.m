...
%   r = quaternion2RotationMatrix(q) converts a unit quaternion, Q, into an orthonormal
%   rotation matrix, r. The input, q, is an 1-by-4 matrix containing a
%   quaternion (q = [w x y z]). Each element of q must be a real number.
%   The output, r, is an 3-by-3 matrix containing rotation matrix.
%% 
