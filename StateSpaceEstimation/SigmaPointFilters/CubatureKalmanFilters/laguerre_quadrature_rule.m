function [ points, weigths ] = laguerre_quadrature_rule( order, alpha )
    % laguerre_quadrature_rule. Calculate cubature points using Gauss-Laguerre quadratures.
    %
    %   [ points, weigths ] = laguerre_quadrature_rule( order, alpha )
    %
