function [ points, weights ] = eval_fifth_degree_cubature_rule(n)
    % eval_fifth_degree_cubature_rule. Evaluate cubature points and weights for 5-th degree Cubature Rule.
    %
    %   INPUT
