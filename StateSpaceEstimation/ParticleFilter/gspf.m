function [ estimate, dataSet, stateNoise, observNoise ] = gspf( dataSet, stateNoise, observNoise, observation, control1, control2, model )
    ...
    for k = 1 : xNoiseMixcompsCnt
        ...
        for g = 1 : xMixcompsCnt
            ...
            xBuf2(:, :, gk) = model.transition_fun(model, xBuf1(:,:,g), xNoiseBuf, control1);
    ...
    for g = 1 : mixcompsCnt,
        ...
        importanceW(g, :) = model.likelihood(model, obs, xBuf3(:, :, g), control2, observNoise) + 1e-99;
    end
    ...
    idx  = resample_mixture_components(xNoiseMixcompsCnt, xMixcompsCnt, xWeigthsNew, model.resampleMethod);
