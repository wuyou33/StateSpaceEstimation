function [ points, weights ] = gauss_hermite_rule( order, dim )
    ...
    %
    %   [ points, weights ] = gauss_hermite_rule( order, dim )
    %
    %   INPUT
    ...
    if nargin == 2
        ...
        points = cartesian_product(replRoots)';
        
        replWeights(1:dim) = {weights};
        tmpWeights = cartesian_product(replWeights)';
