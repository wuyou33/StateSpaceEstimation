function [ outParticels, outIndex ] = residualResample2( particles, weights, noise )
    ...
    %
    %   [ return_resample ] = residualResample2( particles, weights, noise )
    %
    ...
    %
    %   OUTPUT
    %       outParticels  resampled particles;
