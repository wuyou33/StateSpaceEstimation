function [ distanceMatrix ] = euclideanDistance( left, right )
    % dist2 Takes two matrices of vectors and calculates the squared Euclidean distance between them.
    ...
    if dimLeft2 ~= dimRight2; error('[ euclideanDistance ] dimension mismatch'); end
