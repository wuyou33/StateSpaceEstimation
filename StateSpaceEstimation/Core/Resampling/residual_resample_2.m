function [ outIndex ] = residual_resample_2( weights, noise )
    ...
    %
    %   [ outIndex ] = residual_resample_2( particles, weights, noise )
    %
    ...
    switch length(noise)
        ...
        otherwise
            error(['residual_resample_2: Unknown method! The size of the second argument (' inputname(3) ') is wrong.'])
    end
