    ...
    methods
        ...
        function obj = InertialMeasurementUnit(accelerometerParams, ...
            ...
            obj.acceleration = (...
                    ...
                    + (repmat(sqrt(obj.accelerometerParams.NoiseVar), 1, obj.simulationNumber) .* randn(3, obj.simulationNumber))';
            ...
            obj.angularVelocity =    obj.accelerationInBodyFrame.Acceleration / obj.g * obj.gyroParams.GyroGSensitiveBias ...
                ...
                + (repmat(sqrt(obj.gyroParams.GyroNoiseVar), 1, obj.simulationNumber) .* randn(3, obj.simulationNumber))';
        end
        %%
