function [] = SatelliteOrbitVisualization(satellitePhaseState)
    ...
    %
    %   [] = SatelliteOrbitVisualization(satellitePhaseState)
    %
    %   INPUT
    %       satellitePhaseState     trajectory of spacecraft in phase space.
    %
    if (~isa(satellitePhaseState, 'SatellitePhaseSpace'))
        error('[ SatelliteOrbitVisualization::satellitePhaseState ] should be instance of the SatellitePhaseSpace');
    end
